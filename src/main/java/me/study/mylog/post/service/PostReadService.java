...
public class PostReadService {
    ...
    @Transactional(readOnly=true)
    public Page<PostMainResponse> getAllPostDescByBoardId(Long boardId, Pageable pageable) {
    ...
    // 특정 카테코리 게시글 조회
    @Transactional(readOnly=true)
    public Page<PostMainResponse> getAllPostDescByCategoryId(Long categoryId, Pageable pageable) {
    ...
    // 기본 전체 게시글 조회
    @Transactional(readOnly = true)
    public Page<PostMainResponse> getAllPostDesc(Pageable pageable) {
